...
<input type="hidden" name="orderNum" value="${cDTO.num }"><!-- cart번호 -->
		...
		<tr>
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="td_default" width="80" align="center">${cDTO.gCode }</td>
						<td class="td_default" width="80">
							<img src="images/items/${cDTO.gImage }.gif" border="0" align="center"
							width="80" /></td>
